...
glm::mat4 Transform::GetModelInverseMatrixNoTranspose() const
{
...
void Transform::DrawProperties()
{
    ...
    DrawTransformVector3ImGui("Rotation", rotation,0, rotationWidth);
    DrawTransformVector3ImGui("Scale", scale, 1 , scaleWidth);
